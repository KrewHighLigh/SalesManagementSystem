namespace SalesMgrSystem.UI
{
    partial class PaymentForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblMonto=new Label(); txtMonto=new TextBox();
            lblMetodo=new Label(); cmbMetodo=new ComboBox();
            lblNotas=new Label(); txtNotas=new TextBox();
            ...
            Name="PaymentForm"; Text="Gestión de Pagos"; ClientSize=new Size(1050,620); StartPosition=FormStartPosition.CenterScreen;
            ...
            lblHeader.Text="💳  Gestión de Pagos  —  SalesMgrSystem"; lblHeader.Font=new Font("Segoe UI",13f,FontStyle.Bold); lblHeader.ForeColor=Color.FromArgb(137,180,250);
            ...
            lblTituloForm.Location=new Point(24,18); lblTituloForm.Size=new Size(292,26); lblTituloForm.Text="＋  Nuevo Pago"; lblTituloForm.Font=new Font("Segoe UI",11f,FontStyle.Bold); lblTituloForm.ForeColor=Color.FromArgb(137,180,250);
            Lbl(lblOrden,"Orden",54); Cmb(cmbOrden,74);
            Lbl(lblMonto,"Monto ($) *",114);
            txtMonto.Location=new Point(24,134); txtMonto.Size=new Size(292,28); txtMonto.BackColor=Color.FromArgb(49,50,68); txtMonto.ForeColor=Color.FromArgb(205,214,244); txtMonto.BorderStyle=BorderStyle.FixedSingle; txtMonto.Font=new Font("Segoe UI",10f);
            Lbl(lblMetodo,"Método de Pago",174); Cmb(cmbMetodo,194); cmbMetodo.DropDownStyle=ComboBoxStyle.DropDown;
            cmbMetodo.Items.AddRange(new object[]{"Cash","Credit Card","Debit Card","Bank Transfer","PayPal"}); cmbMetodo.SelectedIndex=0;
            Lbl(lblNotas,"Notas",234);
            txtNotas.Location=new Point(24,254); txtNotas.Size=new Size(292,80); txtNotas.Multiline=true; txtNotas.BackColor=Color.FromArgb(49,50,68); txtNotas.ForeColor=Color.FromArgb(205,214,244); txtNotas.BorderStyle=BorderStyle.FixedSingle; txtNotas.Font=new Font("Segoe UI",9.5f);

            void Btn(Button b,string t,int x,Color bg,Color fg){b.Location=new Point(x,350);b.Size=new Size(82,36);b.Text=t;b.Font=new Font("Segoe UI",9f,FontStyle.Bold);b.BackColor=bg;b.ForeColor=fg;b.FlatStyle=FlatStyle.Flat;b.FlatAppearance.BorderSize=0;b.Cursor=Cursors.Hand;}
            ...
            lblEstado.Location=new Point(24,400); lblEstado.Size=new Size(292,50); lblEstado.Text="Listo."; lblEstado.Font=new Font("Segoe UI",8.5f); lblEstado.ForeColor=Color.FromArgb(127,132,156);
            progressBar.Location=new Point(24,456); progressBar.Size=new Size(292,6); progressBar.Style=ProgressBarStyle.Marquee; progressBar.MarqueeAnimationSpeed=30; progressBar.Visible=false;

            btnNuevo.Click+=btnNuevo_Click; btnGuardar.Click+=btnGuardar_Click; btnEliminar.Click+=btnEliminar_Click;
            pnlLeft.Controls.AddRange(new Control[]{lblTituloForm,lblOrden,cmbOrden,lblMonto,txtMonto,lblMetodo,cmbMetodo,lblNotas,txtNotas,btnNuevo,btnGuardar,btnEliminar,lblEstado,progressBar});
            ...
            dgv.Location=new Point(16,66); dgv.Size=new Size(668,520); dgv.Anchor=AnchorStyles.Top|AnchorStyles.Left|AnchorStyles.Right|AnchorStyles.Bottom;
        ...
        private Label lblMonto; private TextBox txtMonto;
        private Label lblMetodo; private ComboBox cmbMetodo;
        private Label lblNotas; private TextBox txtNotas;
