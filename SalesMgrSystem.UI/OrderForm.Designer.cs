namespace SalesMgrSystem.UI
{
    partial class OrderForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblUsuario=new Label(); cmbUsuario=new ComboBox();
            lblTotal=new Label(); txtTotal=new TextBox();
            ...
            Name="OrderForm"; Text="Gestión de Órdenes"; ClientSize=new Size(1050,660); StartPosition=FormStartPosition.CenterScreen;
            ...
            lblHeader.Text="🧾  Gestión de Órdenes  —  SalesMgrSystem"; lblHeader.Font=new Font("Segoe UI",13f,FontStyle.Bold); lblHeader.ForeColor=Color.FromArgb(137,180,250);
            ...
            lblTituloForm.Location=new Point(24,18); lblTituloForm.Size=new Size(292,26); lblTituloForm.Text="＋  Nueva Orden"; lblTituloForm.Font=new Font("Segoe UI",11f,FontStyle.Bold); lblTituloForm.ForeColor=Color.FromArgb(137,180,250);
            Lbl(lblCliente,"Cliente",54); Cmb(cmbCliente,74);
            Lbl(lblUsuario,"Usuario / Vendedor",114); Cmb(cmbUsuario,134);
            Lbl(lblTotal,"Total ($) *",174); Txt(txtTotal,194);
            Lbl(lblStatus,"Estado",234); Cmb(cmbStatus,254);
            cmbStatus.Items.AddRange(new object[]{"Pending","Processing","Completed","Cancelled"}); cmbStatus.SelectedIndex=0; cmbStatus.DropDownStyle=ComboBoxStyle.DropDown;
            Lbl(lblNotas,"Notas",294);
            txtNotas.Location=new Point(24,314); txtNotas.Size=new Size(292,80); txtNotas.Multiline=true; txtNotas.BackColor=Color.FromArgb(49,50,68); txtNotas.ForeColor=Color.FromArgb(205,214,244); txtNotas.BorderStyle=BorderStyle.FixedSingle; txtNotas.Font=new Font("Segoe UI",9.5f);

            void Btn(Button b,string t,int x,Color bg,Color fg){b.Location=new Point(x,412);b.Size=new Size(82,36);b.Text=t;b.Font=new Font("Segoe UI",9f,FontStyle.Bold);b.BackColor=bg;b.ForeColor=fg;b.FlatStyle=FlatStyle.Flat;b.FlatAppearance.BorderSize=0;b.Cursor=Cursors.Hand;}
            ...
            lblEstado.Location=new Point(24,460); lblEstado.Size=new Size(292,50); lblEstado.Text="Listo."; lblEstado.Font=new Font("Segoe UI",8.5f); lblEstado.ForeColor=Color.FromArgb(127,132,156);
            progressBar.Location=new Point(24,516); progressBar.Size=new Size(292,6); progressBar.Style=ProgressBarStyle.Marquee; progressBar.MarqueeAnimationSpeed=30; progressBar.Visible=false;

            btnNuevo.Click+=btnNuevo_Click; btnGuardar.Click+=btnGuardar_Click; btnEliminar.Click+=btnEliminar_Click;
            pnlLeft.Controls.AddRange(new Control[]{lblTituloForm,lblCliente,cmbCliente,lblUsuario,cmbUsuario,lblTotal,txtTotal,lblStatus,cmbStatus,lblNotas,txtNotas,btnNuevo,btnGuardar,btnEliminar,lblEstado,progressBar});
        ...
        private Label lblCliente; private ComboBox cmbCliente;
        private Label lblUsuario; private ComboBox cmbUsuario;
        private Label lblTotal; private TextBox txtTotal;
