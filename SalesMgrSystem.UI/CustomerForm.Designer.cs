namespace SalesMgrSystem.UI
{
    partial class CustomerForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblApellido = new Label(); txtApellido = new TextBox();
            lblEmail = new Label(); txtEmail = new TextBox();
            lblTelefono = new Label(); txtTelefono = new TextBox();
            lblDireccion = new Label(); txtDireccion = new TextBox();
            lblCiudad = new Label(); txtCiudad = new TextBox();
            lblPais = new Label(); txtPais = new TextBox();
            ...
            // FORM
            Name = "CustomerForm"; Text = "Gestión de Clientes";
            ClientSize = new Size(1050, 660); StartPosition = FormStartPosition.CenterScreen;
            ...
            lblHeader.Text = "👤  Gestión de Clientes  —  SalesMgrSystem"; lblHeader.Font = new Font("Segoe UI",13f,FontStyle.Bold); lblHeader.ForeColor = Color.FromArgb(137,180,250);
            ...
            void Txt(TextBox t, int y, int h=28) { t.Location=new Point(24,y); t.Size=new Size(292,h); t.BackColor=Color.FromArgb(49,50,68); t.ForeColor=Color.FromArgb(205,214,244); t.BorderStyle=BorderStyle.FixedSingle; t.Font=new Font("Segoe UI",10f); }

            lblTituloForm.Location = new Point(24,18); lblTituloForm.Size = new Size(292,26); lblTituloForm.Text = "＋  Nuevo Cliente"; lblTituloForm.Font = new Font("Segoe UI",11f,FontStyle.Bold); lblTituloForm.ForeColor = Color.FromArgb(137,180,250);
            Lbl(lblNombre,"Nombre *",54); Txt(txtNombre,74);
            Lbl(lblApellido,"Apellido *",114); Txt(txtApellido,134);
            Lbl(lblEmail,"Email",174); Txt(txtEmail,194);
            Lbl(lblTelefono,"Teléfono",234); Txt(txtTelefono,254);
            Lbl(lblDireccion,"Dirección",294); Txt(txtDireccion,314);
            Lbl(lblCiudad,"Ciudad",354); Txt(txtCiudad,374);
            Lbl(lblPais,"País",414); Txt(txtPais,434);

            void Btn(Button b, string t, int x, Color bg, Color fg) { b.Location=new Point(x,478); b.Size=new Size(82,36); b.Text=t; b.Font=new Font("Segoe UI",9f,FontStyle.Bold); b.BackColor=bg; b.ForeColor=fg; b.FlatStyle=FlatStyle.Flat; b.FlatAppearance.BorderSize=0; b.Cursor=Cursors.Hand; }
            ...
            lblEstado.Location=new Point(24,526); lblEstado.Size=new Size(292,50); lblEstado.Text="Listo."; lblEstado.Font=new Font("Segoe UI",8.5f); lblEstado.ForeColor=Color.FromArgb(127,132,156);
            progressBar.Location=new Point(24,582); progressBar.Size=new Size(292,6); progressBar.Style=ProgressBarStyle.Marquee; progressBar.MarqueeAnimationSpeed=30; progressBar.Visible=false;

            btnNuevo.Click += btnNuevo_Click; btnGuardar.Click += btnGuardar_Click; btnEliminar.Click += btnEliminar_Click;
            pnlLeft.Controls.AddRange(new Control[]{lblTituloForm,lblNombre,txtNombre,lblApellido,txtApellido,lblEmail,txtEmail,lblTelefono,txtTelefono,lblDireccion,txtDireccion,lblCiudad,txtCiudad,lblPais,txtPais,btnNuevo,btnGuardar,btnEliminar,lblEstado,progressBar});
        ...
        private Label lblCiudad; private TextBox txtCiudad;
        private Label lblPais; private TextBox txtPais;
